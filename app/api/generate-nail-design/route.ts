...
Apply the design as if professionally painted. Respect natural nail curvature and realistic lighting. Deliver ONE edited version.`
    ...
    // Using gpt-image-1 with images.edit() for image-to-image editing
    // This preserves the user's hand and only modifies the nails
    ...
    console.log('✅ gpt-image-1 response received, downloading and uploading to R2...')
